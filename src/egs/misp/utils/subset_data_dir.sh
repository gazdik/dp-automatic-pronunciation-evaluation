...
function do_filtering {
  ...
  [ -f $srcdir/text_actual ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/text_actual >$destdir/text_actual
  [ -f $srcdir/text_ext_actual ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/text_ext_actual >$destdir/text_ext_actual
  [ -f $srcdir/text_canonic ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/text_canonic >$destdir/text_canonic
  [ -f $srcdir/text_ext_canonic ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/text_ext_canonic >$destdir/text_ext_canonic
  [ -f $srcdir/text_ext_flags ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/text_ext_flags >$destdir/text_ext_flags
