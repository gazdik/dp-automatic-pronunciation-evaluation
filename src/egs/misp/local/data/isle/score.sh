...
if [ $stage -le 1 ]; then
  $cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring/log/map_ctm.LMWT.log \
     ...
     $dir/scoring/LMWT.ctm_phn || exit 1
fi

# Score the set...
$cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring/log/score.LMWT.log \
  cp $dir/scoring/stm $dir/score_LMWT/stm '&&' cp $dir/scoring/LMWT.ctm_phn $dir/score_LMWT/ctm_phn '&&' \
  $hubscr -p $hubdir -V -l english -h hub5 -g $dir/scoring/glm -r $dir/score_LMWT/stm $dir/score_LMWT/ctm_phn || exit 1;
exit 0;
